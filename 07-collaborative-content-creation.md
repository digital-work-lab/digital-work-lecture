...
**Part 1**: Branches (90 min)
**Part 2**: Local changes (90 min)
...
- A **commit** refers to a snapshot of the whole project directory, including the meta data and the tree (all files)
